...
const REQUIRED_KEYS = [
  ...
  "be.news.pressConference.headlineResultVerdict",
  "be.news.pressConference.headlineResultDefiant",
  "be.news.pressConference.headlinePlayerPraise",
  "be.news.pressConference.headlinePlayerDemand",
  "be.news.pressConference.headlineOpponentRespect",
  "be.news.pressConference.headlineOpponentWarning",
  "be.news.pressConference.headlineLookingAhead",
  "be.news.pressConference.bodyResultReaction",
  "be.news.pressConference.bodyPlayerFocus",
  "be.news.pressConference.bodyOpponentFocus",
  "be.news.pressConference.bodyLookingAhead",
