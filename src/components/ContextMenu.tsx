        ...
        {visible &&
          createPortal(
            <div
              ref={menuRef}
              role="menu"
              className="fixed z-50 min-w-[180px] bg-white dark:bg-navy-800 rounded-lg shadow-xl border border-gray-200 dark:border-navy-600 py-1 motion-safe:animate-in motion-safe:fade-in motion-safe:duration-100"
